...
def open_new_window():
    window2 = Toplevel()
    window2.title("Installing windows 13")
    label = Label(window2, image=bilgo)
    label.place(x = 60,y = 50)
    ttk.Label(window2, text="Installing, thanks for your patience.", font=('Helvetica', 15)).pack()
    ttk.Label(window2, text="You can close this window now.", font=('Helvetica', 15)).pack()
...
b = ttk.Button(root, text='¡Install NOW!', style='my.TButton', command=open_new_window)
...
root.title("Windows 13 Installer")
