...
def open_new_window():
    window2 = Toplevel()
    window2.title("Instalando windows 13")
    label = Label(window2, image=bilgo)
    label.place(x = 60,y = 50)
    ttk.Label(window2, text="Iniciando instalacion, espera unos minutos.", font=('Helvetica', 15)).pack()
    ttk.Label(window2, text="puedes cerrar esta ventana", font=('Helvetica', 15)).pack()
...
b = ttk.Button(root, text='Instalar windows 13', style='my.TButton', command=open_new_window)
...
root.title("Instalador de windows 13")
